 ...
 * 
 * Disassembly of iASLUDJmJy.aml, Sun Aug 10 15:46:23 2014
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000C0FB (49403)
 *     Revision         0x02
 *     Checksum         0xF9
 *     OEM ID           "Apple "
 *     OEM Table ID     "A M I"
 ...
 */
DefinitionBlock ("iASLUDJmJy.aml", "DSDT", 2, "Apple ", "A M I", 0x000000F9)
{
    /*
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0x7E1E9C18, 0x027E)
    ...
    Scope (_SB.PCI0.LPCB)
    {
        OperationRegion (CPSB, SystemMemory, 0x7E0FAE18, 0x10)
    ...
    Scope (_SB)
    {
        Device (PTMD)
        {
            ...
            {
                OperationRegion (GCAD, SystemMemory, 0x7E1D9018, 0x00FC)
            ...
            {
                OperationRegion (GDAD, SystemMemory, 0x7E1D7018, 0x05F8)
